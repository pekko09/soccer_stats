...
There will be multiple add-ons in the future. Several ideas are in my mind but will be added in my spare time without fixed and strict schedule.
This project is a fun development project to experiment with Python, APIs, and GitHub Actions. It has no commercial purpose. 
